...
mychisim<-function(n1=10,sigma1=3,mean1=5,iter=1000,ymax=0.1,...){
  ...
  legend(x =2 ,y =0,c("Simulated","Theoretical"),col=c("Blue","Red"),lwd=4,lty=1:2,bty="n",title=title)
  ### Function Return ###
...
### Plot: 1/4
```{r}
mychisim(n1 = 10, iter=1000,mean1 = 10,sigma1 = 4,ymax=0.2)
```


### Plot: 2/4
```{r}
mychisim(n1 = 20, iter=1000,mean1 = 10,sigma1 = 4,ymax=0.15)
```

### Plot: 3/4
```{r}
mychisim(n1 = 100, iter=1000,mean1 = 10,sigma1 = 4,ymax=0.15)
```

### Plot: 4/4
```{r}
mychisim(n1 = 200, iter=1000,mean1 = 10,sigma1 = 4,ymax=0.15)
```
