...
#' @param x    Data vector
#' @param fun  Function desired
#' @param alpha Confidence interval: (1-alpha)*100 = percent. 95\%-> alpha=0.05
#' @param cx    text size
#' @param ...   other parameters
#' @description
#' This is a confidence interval placed on a histogram representing the function used.
#'
#' @return    A histogram and list of calculated values like confidence interval
#' @export
#'
#' @examples
